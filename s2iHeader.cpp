...
const string ConstantStuff::VERSION_STRING = "1.1";
const int ConstantStuff::UNDEFINED = 0;
const int ConstantStuff::OUTPUT_LOW = 0;
const int ConstantStuff::OUTPUT_HIGH = 1;
const int ConstantStuff::OUTPUT_FALLING = 0;
const int ConstantStuff::OUTPUT_RISING = 1;
const int ConstantStuff::DISABLE_OUTPUT = 0;
const int ConstantStuff::ENABLE_OUTPUT = 1;

const int ConstantStuff::TYP_CASE = 0;
const int ConstantStuff::MIN_CASE = -1;
const int ConstantStuff::MAX_CASE = 1;

const int ConstantStuff::NUM_PTS_LINEAR_REGION = 10;

/* ibis version 1.0 Restriction */
const int ConstantStuff::MAX_TABLE_SIZE = 100;
const int ConstantStuff::MAX_MANUFACTURERS_NAME_LENGTH = 40;
const int ConstantStuff::MAX_FILENAME_BASE_LENGTH = 20;
const string ConstantStuff::FILENAME_EXTENSION = "ibs";
const int ConstantStuff::FILENAME_EXTENSION_LENGTH = 3;
const int ConstantStuff::MAX_PIN_NAME_LENGTH = 5;
const int ConstantStuff::MAX_SIGNAL_NAME_LENGTH = 20;
const int ConstantStuff::MAX_MODEL_NAME_LENGTH = 20;
const int ConstantStuff::MAX_R_PIN_STRING_LENGTH = 9;
const int ConstantStuff::MAX_L_PIN_STRING_LENGTH = 9;
const int ConstantStuff::MAX_C_PIN_STRING_LENGTH = 9;
const int ConstantStuff::MAX_LINE_LENGTH = 80;
const int ConstantStuff::MAX_COMPONENT_NAME_LENGTH = 40;
const int ConstantStuff::MAX_FILENAME_LENGTH =
    MAX_FILENAME_BASE_LENGTH + 1 + FILENAME_EXTENSION_LENGTH;

/* additional ibis version 2.0 Restriction */
const int ConstantStuff::MAX_PACKAGE_MODEL_NAME_LENGTH = 40;
const int ConstantStuff::MAX_PIN_MAPPING_NAME_LENGTH = 15;
const int ConstantStuff::MAX_DFF_PIN_NAME_LENGTH = 5;
const int ConstantStuff::MAX_INV_PIN_LEBGTH = 5;
const int ConstantStuff::MAX_VDIFF_TYP_LENGTH = 9;
const int ConstantStuff::MAX_TEDELAY_MAX_LENGTH = 9;
const int ConstantStuff::MAX_WAVEFORM_TABLES = 100;
const int ConstantStuff::MAX_SERIES_TABLES = 100;

const int ConstantStuff::MAX_FILE_REV_LENGTH = 4;
const int ConstantStuff::MAX_TOK_LEN = 40;
const int ConstantStuff::MAX_DATE_STRING_LENGTH = 40;
const int ConstantStuff::MAX_IBIS_STRING_LENGTH = 1024;
...
const int ConstantStuff::IBIS_PRINT_WIDTH = 80;

const double ConstantStuff::USE_NA = -1.33287736222333E20;
const double ConstantStuff::NOT_USED = -1.33287736222333E18;
const double ConstantStuff::Tolerance = 1E15;
/* VI Curve types */
const int ConstantStuff::CURVE_TYPE_PULLUP = 0;
const int ConstantStuff::CURVE_TYPE_PULLDOWN = 1;
const int ConstantStuff::CURVE_TYPE_POWER_CLAMP = 2;
const int ConstantStuff::CURVE_TYPE_GND_CLAMP = 3;
const int ConstantStuff::CURVE_TYPE_DISABLED_PULLUP = 4;
const int ConstantStuff::CURVE_TYPE_DISABLED_PULLDOWN = 5;
const int ConstantStuff::CURVE_TYPE_RISING_RAMP = 6;
const int ConstantStuff::CURVE_TYPE_FALLING_RAMP = 7;
const int ConstantStuff::CURVE_TYPE_RISING_WAVE = 8;
const int ConstantStuff::CURVE_TYPE_FALLING_WAVE = 9;
/*series*/
const int ConstantStuff::CURVE_TYPE_SERIES_VI = 10;

const int ConstantStuff::majorReleaseIncrement = 1000;
const int ConstantStuff::minorReleaseIncrement = 50;

const int ConstantStuff::VERSION_ONE_ZERO = goodies::VERSION_ID(1, 0, 0);
const int ConstantStuff::VERSION_ONE_ONE = goodies::VERSION_ID(1, 1, 0);
const int ConstantStuff::VERSION_TWO_ZERO = goodies::VERSION_ID(2, 0, 0);
const int ConstantStuff::VERSION_TWO_ONE = goodies::VERSION_ID(2, 1, 0);

/*s2ibis3*/
const int ConstantStuff::VERSION_THREE_TWO = goodies::VERSION_ID(3, 2, 0);

/* Model Types */
const int ConstantStuff::MODEL_TYPE_UNDEFINED = UNDEFINED;

/* version 1.0 */
const int ConstantStuff::MODEL_TYPE_INPUT = goodies::VERSION_ID(1, 0, 1);
const int ConstantStuff::MODEL_TYPE_OUTPUT = goodies::VERSION_ID(1, 0, 2);
const int ConstantStuff::MODEL_TYPE_OPEN_DRAIN = goodies::VERSION_ID(1, 0, 4);
const int ConstantStuff::MODEL_TYPE_3_STATE = goodies::VERSION_ID(1, 0, 3);
const int ConstantStuff::MODEL_TYPE_I_O = goodies::VERSION_ID(1, 0, 5);
/* version 2.0 */
const int ConstantStuff::MODEL_TYPE_I_O_OPEN_DRAIN =
    goodies::VERSION_ID(2, 0, 1);
const int ConstantStuff::MODEL_TYPE_I_O_OPEN_SINK =
    goodies::VERSION_ID(2, 0, 2);
const int ConstantStuff::MODEL_TYPE_I_O_OPEN_SOURCE =
    goodies::VERSION_ID(2, 0, 3);
const int ConstantStuff::MODEL_TYPE_INPUT_ECL = goodies::VERSION_ID(2, 0, 4);
const int ConstantStuff::MODEL_TYPE_I_O_ECL = goodies::VERSION_ID(2, 0, 5);
const int ConstantStuff::MODEL_TYPE_TERMINATOR = goodies::VERSION_ID(2, 0, 6);
const int ConstantStuff::MODEL_TYPE_OPEN_SINK = goodies::VERSION_ID(2, 0, 7);
const int ConstantStuff::MODEL_TYPE_OPEN_SOURCE = goodies::VERSION_ID(2, 0, 8);
const int ConstantStuff::MODEL_TYPE_OUTPUT_ECL = goodies::VERSION_ID(2, 0, 9);
/* version 3.2 */
const int ConstantStuff::MODEL_TYPE_SERIES = goodies::VERSION_ID(3, 0, 1);
const int ConstantStuff::MODEL_TYPE_SERIES_SWITCH =
    goodies::VERSION_ID(3, 0, 2);

/* Model Enable types */
const int ConstantStuff::MODEL_ENABLE_UNDEFINED = ConstantStuff::UNDEFINED;
/* version 1.0 */
const int ConstantStuff::MODEL_ENABLE_ACTIVE_HIGH =
    goodies::VERSION_ID(1, 2, 1);
const int ConstantStuff::MODEL_ENABLE_ACTIVE_LOW = goodies::VERSION_ID(1, 2, 2);

/* Model Polarity types */
const int ConstantStuff::MODEL_POLARITY_UNDEFINED = ConstantStuff::UNDEFINED;
/* version 1.0 */
const int ConstantStuff::MODEL_POLARITY_NON_INVERTING =
    goodies::VERSION_ID(1, 3, 1);
const int ConstantStuff::MODEL_POLARITY_INVERTING =
    goodies::VERSION_ID(1, 3, 2);

/* Supported Spice types */
const int ConstantStuff::SPICE_TYPE_HSPICE = 0;
const int ConstantStuff::SPICE_TYPE_PSPICE = 1;
const int ConstantStuff::SPICE_TYPE_SPICE2 = 2;
const int ConstantStuff::SPICE_TYPE_SPICE3 = 3;
const int ConstantStuff::SPICE_TYPE_SPECTRE = 4;
const int ConstantStuff::SPICE_TYPE_ELDO = 5;

/* SPICE exit code (no execution errors) */
const int ConstantStuff::SPICE_GOOD_EXIT_CODE = 0;

/* This section supplies all of the component and model default values.
 */
const int ConstantStuff::RLOAD_DEFAULT = 50;
const double ConstantStuff::C_COMP_DEFAULT = 5E-12;
const int ConstantStuff::TEMP_TYP_DEFAULT = 27;
const int ConstantStuff::TEMP_MIN_DEFAULT = 100;
const int ConstantStuff::TEMP_MAX_DEFAULT = 0;
const int ConstantStuff::VOLTAGE_RANGE_TYP_DEFAULT = 5;
const double ConstantStuff::VOLTAGE_RANGE_MIN_DEFAULT = 4.5;
const double ConstantStuff::VOLTAGE_RANGE_MAX_DEFAULT = 5.5;
const double ConstantStuff::SIM_TIME_DEFAULT = 10e-9;
const int ConstantStuff::SPICE_TYPE_DEFAULT = SPICE_TYPE_HSPICE;
const int ConstantStuff::DERATE_VI_PCT_DEFAULT = 0;
const int ConstantStuff::DERATE_RAMP_PCT_DEFAULT = 0;
const int ConstantStuff::CLAMP_TOLERANCE_DEFAULT = 0;
const double ConstantStuff::R_SERIES_DEFAULT = 1E6;
const double ConstantStuff::HSPICE_INGOLD_DEFAULT = 2;
/*-------------------------------------------------------------------------
 *   Define some global component default values.  These go into the
 *   components if not otherwise specified.
 *------------------------------------------------------------------------*/
const string ConstantStuff::MANUFACTURERS_NAME_DEFAULT = "Manufacturer name";
const int ConstantStuff::R_PKG_DEFAULT = 0;
const int ConstantStuff::L_PKG_DEFAULT = 0;
const int ConstantStuff::C_PKG_DEFAULT = 0;
 ...
 *   number.
 *------------------------------------------------------------------------*/
const double ConstantStuff::LIN_RANGE_DEFAULT = 5.0;
const double ConstantStuff::SWEEP_STEP_DEFAULT = 0.01;
const double ConstantStuff::DIODE_DROP_DEFAULT = 1.0;
const double ConstantStuff::ECL_SWEEP_RANGE_DEFAULT = 2.2;
const double ConstantStuff::ECL_TERMINATION_VOLTAGE_DEFAULT = -2.0;
const int ConstantStuff::WAVE_POINTS_DEFAULT = 100;
...
//  string[] convergenceMarker = {"convergence failure", // only one that is
//  valid
...
// public:
//  string DCSrcString(int aspiceType, string var1, string nodeName, string
//  var2,
//                     double var3) {
//    string[] srcString = {
...
// public:
//  void setnext(ibisPinMap nextPinMap1) { nextPinMap = nextPinMap1; } //
//  setnext
